...
def main(bili_str,baifenbi):
    ...
    snapshot_path=f'/mnt/hys/CPAC_Net/My_mt_with_reg_strong_weak_outputs_75%/20251226_lr_1e-3_500epoch_置信度阈值95e-2_consis_1e-2-11e-2_CE_s_w_threshold_6e-1_4e-1_aug2_wo_pse_label_correct_and_rs_testbest'

    if not os.path.exists(snapshot_path):
        print("%s没有，正在创建" % snapshot_path)
        os.makedirs(snapshot_path)
    source1 = '/mnt/hys/CPAC_Net/train_my_mt_with_reg_同个病人_strong_weak_75%_wo_reg_and_correct.py'
