"""
    ...
    此代码为用来模拟随访场景下的实验效果。33%是由于同患者4张图像有3张用于训练（其中1张有标签，2张无标签），1张用于测试.
...
def main(bili_str,baifenbi):
    ...
    snapshot_path=f'/mnt/hys/CPAC_Net/My_mt_with_reg_strong_weak_outputs_33percent/lr_1e-3_500epoch_置信度阈值95e-2_20250421_consis_1e-2-11e-2_CE_s_w_threshold_6e-1_4e-1_变形图像也参与训练0.5_aug2'

    if not os.path.exists(snapshot_path):
        print("%s没有，正在创建" % snapshot_path)
        os.makedirs(snapshot_path)
    source1 = '/mnt/hys/CPAC_Net/train_my_mt_with_reg_同个病人_strong_weak_33percent.py'
