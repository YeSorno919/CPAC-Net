...
def main(bili_str,baifenbi):
    ...
    snapshot_path=f'/mnt/hys/CPAC_Net/My_mt_with_reg_strong_weak_outputs/25%_lr_1e-3_500epoch_置信度阈值95e-2_20250612_consis_1e-2-2e-2_CE_s_w_threshold_6e-1_4e-1_变形图像也参与训练0.5_概率固定强增强'
    ...
    source1 = '/mnt/hys/CPAC_Net/train_my_mt_with_reg_同个病人_strong_weak_概率独立强增强.py'
