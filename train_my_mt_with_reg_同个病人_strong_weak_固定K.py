    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            if(strong_augmentation_num>0):
                ...
                with torch.no_grad():
                    for b in range(0,batch):
                        ...
                        if(iter_num%len(trainloader)==0 and epoch_num%10 ==0 and False):
                            plt.rcParams['font.size'] = 30
            ...
            with autocast():
                ...
                if(iter_num%len(trainloader)==0 and epoch_num%100 ==0 and False):
                # if(1):
                    plt.rcParams['font.size'] = 30
...
def main(bili_str,baifenbi):
    ...
    snapshot_path=f'/mnt/hys/CPAC_Net/My_mt_with_reg_strong_weak_outputs/25%_lr_1e-3_500epoch_置信度阈值95e-2_20250611_consis_1e-2-2e-2_CE_s_w_threshold_6e-1_4e-1_变形图像也参与训练0.5_aug7_固定K'
    ...
    source1 = '/mnt/hys/CPAC_Net/train_my_mt_with_reg_同个病人_strong_weak_固定K.py'
